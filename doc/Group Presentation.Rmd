...
```{r, include=FALSE, fig.align = "left"}
...
+-----------------------------------------------------------+-----------------------------------------------------------+
| ![](/cloud/project/results/heatmapPAM50.png){width="343"} | ![](/cloud/project/results/heatmapTumor.png){width="400"} |
+-----------------------------------------------------------+-----------------------------------------------------------+


## Principal components and k-means

+----------------------------------------------------------------+-----------------------------------------------------+
| ![](/cloud/project/results/pcaRotationMatrix.png){width="397"} | ![](/cloud/project/results/kplot1.png){width="316"} |
+----------------------------------------------------------------+-----------------------------------------------------+
...
+-----------------------------------------------------------+-----------------------------------------------------------+
| ![](/cloud/project/results/heatmapPAM50.png){width="380"} | ![](/cloud/project/results/heatmapTumor.png){width="380"} |
+-----------------------------------------------------------+-----------------------------------------------------------+
>>>>>>> c72db6a94f4188b2b61f9bee4d3ec5ea2c1153fe
